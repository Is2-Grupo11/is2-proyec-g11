        ...
        <div class="py-12 w-full">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                        <div class="flex p-2">
                            <a href="{{ url('/backlogs') }}" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-white rounded-md">Listar Backlogs</a>
                        </div>
                ...
                <div class="mt-6 p-2 bg-slate-100">
                    <h2 class="text-2xl font-semibold">Proyecto Asociado:</h2>
                    <div class="flex space-x-2 mt-4 p-2">
                        @foreach ($backlogs_project as $backlogs_proyect)
