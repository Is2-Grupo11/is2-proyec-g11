        ...
        <x-success-status class="mb-3 ml-40" :status="session('message')" />
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="py-4 px-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class ="form-group">
                        <button class = " delay-100 duration-100 transform hover:scale-125 transition ease-linear bg-teal-400 px-6 py-2 m-4 inline">Guardar backlog</button>
                    </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ url('/backlog_project/'.$backlog->id) }}" class="btn btn-primary">Asociar</a></td>
                                <td>
                            ...
                            @empty
                            <tr>
                                <td colspan="6">No existe proyecto</td>
                            </tr>
                            @endforelse
